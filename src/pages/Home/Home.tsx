...
const scrollData = [
	...
	},
	{
		...
		subheader:
			"Enjoy uninterrupted views with our sleek, frame-less designs.",
		img: scrollerImage,
		alt: "scroll image",
	},
	{
		...
		subheader:
			"Clean lines and understated designs that complement any decor.",
		img: scrollerImage,
		alt: "scroll image",
	},
	{
	...
	return (
		<main>
			...
			<section className="flex flex-col lg:flex-row justify-center gap-8 px-10 phone:px-20 md:px-32 xl:px-44 pb-9 phone:pb-16 md:pb-24 xl:pb-36 pt-6 phone:pt-14 md:pt-24 xl:pt-36">
				<div className="flex flex-col gap-2 phone:gap-4">
					...
					<p className="w-full lg:w-[37rem] text-xs md:text-base lg:text-lg xl:text-xl italic text-[--grey]">
						At Imperio, we specialize in creating beautiful, durable
						glass railing systems that enhance any space. With a
						focus on innovation and quality, our team is dedicated
						to delivering top-notch solutions for both residential
						...
						{scrollData.map((item, index) => (
							<div className="space-y-8" key={index}>
								...
								<div className="flex flex-col text-white">
									...
									<p className="text-xs w-11/12 italic">
										{item.subheader}
									</p>
								</div>
							</div>
			...
			<Description
				...
				text={
					<>
						Our portfolio features diverse projects, from luxury
						residential
						<br />
