  ...
  return (
    <>
      <Metadata
        ...
        description={
          "Compare stainless steel and aluminium glass railings. Explore their benefits, costs, and durability for balconies, decks, and staircases. Make an informed choice for your home or business."
        }
        keywords={
