...
const blogPosts: BlogPost[] = [
  {
    id: 1,
    title:
      "Lotus Signature Terrace Glass Railing: A Fusion of Elegance and Safety",
    excerpt:
  ...
  },
  {
    id: 3,
    title:
      "Sivanta Apartment Terrace Glass Railing: Seamless Elegance with Swimming Pool Views",
    excerpt:
