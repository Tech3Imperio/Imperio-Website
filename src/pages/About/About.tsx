        ...
        <div className=" grid md:grid-cols-3 justify-between items-center mx-10 my-auto xl:px-[15rem] gap-10 md:gap-14">
          <div className=" flex flex-col justify-center rounded-2xl md:mt-32 shadow-md shadow-[#f5ce02]">
            ...
            <p className="text-[10px] lg:text-[0.900rem] px-2 text-[#d4d5d6] text-justify ">
              At{" "}
              <strong className=" text-white ">Imperio Railing Systems,</strong>{" "}
              ...
              facades. Our commitment to innovation ensures that each system not
              only meets but exceeds industry standards. By integrating advanced
              technology with sustainable practices, we aim to provide
              environmentally friendly and long-lasting solutions. Our goal is
              to transform spaces with stylish and secure glass railings,
              fostering a culture of excellence and customer satisfaction. Trust
              us to deliver the perfect railing system for your home or building
              project.
            </p>
          </div>
          <div className=" flex flex-col justify-center rounded-2xl shadow-md shadow-[#f5ce02]">
            ...
            <p className=" text-[10px] lg:text-[0.900rem] px-2 text-[#d4d5d6] text-justify">
              ...
              principles underpin all our operations. Our dedication to product
              quality and glass railing durability reflects our belief in
              delivering top-notch, high-quality glass railings for both
              ...
              partnerships built on mutual respect and satisfaction. By adhering
              to these fundamental values, we strive to set the standard for
              excellence in glass railing solutions and maintain our reputation
              as a leader in the industry. Our mission is to consistently
              provide elegant glass railings that enhance the safety and
              aesthetics of every space, ensuring unparalleled performance and
              lasting durability.
            </p>
          </div>
          <div className=" flex flex-col justify-center h-auto rounded-2xl md:mt-32 shadow-md shadow-[#f5ce02]">
            ...
            <p className=" text-[10px] lg:text-[0.900rem] px-2 text-[#d4d5d6] text-justify">
              ...
              railing solutions, known for our relentless pursuit of innovation
              and excellence. We aspire to set the standard for superior design
              and unmatched craftsmanship in the glass railing industry. By
              focusing on delivering cutting-edge, high-quality glass railings
              for residential and commercial spaces, including balconies,
              staircases, and building facades, we aim to elevate the aesthetic
              and safety of every project. We are committed to utilizing the
              latest technology and sustainable practices to offer durable and
              stylish glass railings. Our goal is to be the preferred choice for
              customers seeking elegant and reliable glass railing systems that
              enhance their spaces and exceed their expectations.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="py-1 text-[0.900rem]">
            <ul className="flex flex-col gap-4 text-[#03237b] text-justify">
              <li className=" flex flex-row gap-6 ">
                ...
                railings provide a seamless look, creating an open and inviting
                outdoor space. Experience the perfect blend of style and
                sophistication with our modern designs.
              </li>
              <li className=" flex flex-row gap-6">
              ...
              <li className=" flex flex-row gap-6">
                ...
                Our balcony railing systems are designed for easy installation,
                making the process hassle-free for homeowners and contractors
                alike. Additionally, our glass materials require minimal
                maintenance, ensuring they remain pristine for years to come.
                Enjoy elegance and convenience with every railing solution.
              </li>
            </ul>
          </div>
        </div>
