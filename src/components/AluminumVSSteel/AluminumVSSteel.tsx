      ...
      <motion.main className="max-w-6xl mx-auto w-full">
        ...
        >
          ...
          <p className="text-[#292929] leading-relaxed text-justify">
            ...
            solutions that combine style and strength.
          </p>
        </motion.section>
        ...
        >
          ...
          <p className="text-[#292929] leading-relaxed text-justify">
            ...
            stainless steel glass railings might be the better option. They are
            ideal for high-traffic areas or situations where you need a more
            robust railing system.
          </p>
          <p className="text-[#292929] leading-relaxed text-justify">
            <strong>Aluminium Glass Railings</strong> for <b>Decks,</b>{" "}
            <b>Balconies,</b> and <b>Stairs</b> For decks, <b>balconies,</b> and
            stairs, aluminium glass railings are a perfect fit. The lightweight,
            rust-resistant nature of aluminium makes it an excellent choice for
            outdoor spaces, where it can withstand exposure to the elements.
            Whether you're installing glass railings for your balcony or
            upgrading your deck,{" "}
            ...
            <b>balcony,</b> or <b>staircase</b> might be the right choice. These
            railings offer unmatched durability, making them ideal for
