...
//               className="border-2 border-white rounded-l-full p-[0.65rem] tablet:p-4 pl-3 tablet:pl-6 max-tablet:h-8 w-40 phone:w-[13rem] tablet:w-[17rem] laptop:w-80 transition duration-700 group-hover:border-[--secound] group-focus-within:border-[--secound] outline-none"
//             />
//             <button
...
//                 height="20"
//                 viewBox="0 0 24 20"
//                 className="w-3 tablet:w-6 h-[0.65rem] tablet:h-5"
//                 fill="none"
//                 xmlns="http://www.w3.org/2000/svg"
//               >
//                 <path
...
//           <div className="flex flex-col gap-3 text-xs tablet:text-sm laptop:text-base">
//             <h6>Headquarters</h6>
//             <p>123 Glassway St., Metropolis, USA</p>
//           </div>
//         </div>
//       </aside>
//     </footer>
