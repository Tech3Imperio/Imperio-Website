					...
					return (
						<div
							...
							className={classNames(
								"absolute text-white p-9 w-[19rem] h-[9.5rem] phone:w-[26rem] phone:h-[13rem] tablet:w-[33rem] tablet:h-[16.5rem] laptop:w-[40rem] laptop:h-80 flex justify-center items-center gap-4 phone:gap-5 tablet:gap-7 laptop:gap-9 rounded-4xl transition-all duration-500 ease-in-out",
								{
									"bg-[--black] z-20 transform scale-110 opacity-100 -translate-x-1/2 translate-y-32 phone:translate-y-28 tablet:translate-y-16 laptop:translate-y-0":
										isCurrent,
									"bg-[--grey] z-10 opacity-70 transform scale-95 translate-y-52 phone:translate-y-52 tablet:translate-y-44 laptop:translate-y-32 -translate-x-[98%]":
										isPrev,
									"bg-[--grey] z-10 opacity-70 transform scale-95 translate-y-52 phone:translate-y-52 tablet:translate-y-44 laptop:translate-y-32	 translate-x-[8%]":
										isNext,
									"opacity-0":
