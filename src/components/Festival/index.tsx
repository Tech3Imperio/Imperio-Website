...
//       <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:mt-24 xl:mt-10">
//         <AnimatePresence mode="wait">
//           <motion.div
//             key={activeIndex}
//             initial={{ opacity: 0, y: 50 }}
...
//               }`}
//             >
//               <h2 className="text-xl font-semibold mb-2">{slide.product}</h2>
//               <p className="text-gray-300">{slide.prodDect}</p>
//             </motion.div>
//           ))}
//         </div>
