    ...
    <section className={`py-20 mx-auto max-w-7xl ${className}`}>
      <div className="flex justify-between items-start max-lg:flex-col gap-4 px-4">
        ...
        <aside className="flex flex-col items-center justify-center gap-4 tablet:flex-row tablet:justify-center tablet:gap-8">
          <div className="flex flex-wrap justify-center p-[0.50rem] gap-2 lg:gap-4 border border-gray-500 rounded-none -mt-3  sm:ml-0">
          ...
          <button
            ...
            className="min-w-fit py-3 mb-3 tablet:py-4 px-5 laptop:px-6 text-sm text-white bg-[--black] font-normal rounded-none transition-700 hover:text-[--black] hover:bg-[--secound]"
          >
            Reset Filters
          </button>
        </aside>
        ...
        {filteredBlogs.length > 0
          ...
          : Array(cardsToShow)
              ...
              .map((_, index) => (
                <div
                  key={index}
                  className="relative w-[22rem] space-y-3 overflow-hidden rounded-none bg-white  shadow-lg before:absolute before:inset-0 before:-translate-x-full before:bg-gradient-to-r before:from-transparent before:via-white/20 hover:shadow-lg before:animate-[shimmer_1.5s_infinite]"
                >
                  <div className="h-72 w-full rounded-none bg-neutral-400"></div>
                  <div className="space-y-3 p-4">
                    <div className="h-5 w-full rounded-none bg-neutral-400"></div>
                    <div className="space-y-1">
                      <div className="h-4 w-8/12 rounded-none bg-neutral-400 shadow"></div>
                    </div>
                    <div className="flex justify-between gap-4">
                      <div className="flex gap-4">
                        <div className="h-5 w-16 rounded-none bg-neutral-400"></div>
                        <div className="h-5 w-16 rounded-none bg-neutral-400"></div>
                      </div>
                      <div className="h-5 w-16 rounded-none bg-neutral-400"></div>
                    </div>
      ...
      {selectedBlog && (
        ...
        >
          <div
            className={`fixed left-1/2 tablet:top-1/2 -translate-x-1/2 tablet:-translate-x-0 -translate-y-0 tablet:-translate-y-1/2 h-[45vh] tablet:h-[99%] w-[95%] tablet:w-[40vw] rounded-none bg-white p-6 shadow-lg transition-700 overflow-y-scroll noscroll ${
              selectedBlog
                ? "top-4 tablet:left-4"
          ...
          >
            ...
            <div className="flex justify-center items-center overflow-hidden rounded-none ">
              <img
                src={selectedBlog.img}
                alt={selectedBlog.alt}
                className="max-h-[570px] rounded-none"
              />
            </div>
          </div>
        </div>
