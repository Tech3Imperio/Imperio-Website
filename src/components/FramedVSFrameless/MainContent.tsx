...
//                 </li>
//                 <li>
//                   No frames to worry about painting, saving time and money.
//                 </li>
//                 <li>
//                   They have less environmental impact due to minimal material
//                   usage.
...
// </p>
// <div className="bg-white p-6 rounded-lg shadow-lg">
//   <div className="text-2xl font-semibold mb-4 text-[#03237b]">
//     DoubleTree by Hilton and W Hotel Goa
//   </div>
//   <p className="text-[#292929] mb-4">
//     Two luxury seaside resorts in Goa sought to elevate their terrace,
//     balcony, and pool designs with{" "}
//     <strong>frameless glass railings</strong>. The goal was to create
//     an open and unobstructed view of the ocean while maintaining
//     safety. By utilizing frameless glass railings, the resorts
//     achieved their desired aesthetic and ensured lasting durability
